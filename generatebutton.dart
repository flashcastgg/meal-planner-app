              ...
              children: List.generate(categories.length, (index) {
                ...
                return Expanded(
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () => setState(() => selectedCategory = index),
                      style: ElevatedButton.styleFrom(
                        backgroundColor: isSelected ? Colors.indigo : Colors.grey[300],
                        foregroundColor: isSelected ? Colors.white : Colors.black,
                      ),
          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Enter your ${currentCategory.toLowerCase()} meals below:', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
